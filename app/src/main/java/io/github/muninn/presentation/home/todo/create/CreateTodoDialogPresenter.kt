...
class CreateTodoDialogPresenter : BasePresenter<CreateTodoDialogContract.View>(),
    ...
    override fun prepareCalendar(): Calendar {
        return Calendar.getInstance()
    }

    override fun saveTemporaryStartDateChoice(year: Int, monthOfYear: Int, dayOfMonth: Int) {
        choice = DateTimeTemporaryChoice(year, monthOfYear, dayOfMonth)
        view!!.showStartDate(choice!!)
    }

    override fun saveTemporaryDueDateChoice(year: Int, monthOfYear: Int, dayOfMonth: Int) {
